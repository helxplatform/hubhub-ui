      ...
      <Box sx={{
        ...
        <Stack spacing={ 0.5 } className="link-stack">
          <span>
            ...
            <span className="date">
              {' '}&mdash;{' '} { github_tag_date ? new Date(github_tag_date).toDateString() : 'date unknown' }
            </span>
          </span>
            ...
            github_commit_hash
              ? (
                <span>
                  ...
                  <span className="date">
                    {' '}&mdash;{' '} { github_commit_date ? new Date(github_commit_date).toDateString() : 'date unknown' }
                  </span>
                </span>
